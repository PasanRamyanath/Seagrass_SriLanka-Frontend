...
const Home = () => {
  ...
  <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] z-10">
    <svg
      className="relative block w-[calc(100%+1.3px)] h-[50px] sm:h-[60px] md:h-[80px]"
    ...
    >
      ...
      <div className="w-full my-8 sm:my-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 py-6 sm:py-10">
          {/* Left: Text */}
        ...
        <div className="w-full border-t border-gray-300 mt-6 sm:mt-8"></div>
      </div>
      ...
      <div className="flex flex-wrap md:flex-nowrap px-4 sm:px-6 lg:px-8 py-6 sm:py-8 gap-6 sm:gap-8 max-w-7xl mx-auto">
        {/* Left Column - Heading */}
